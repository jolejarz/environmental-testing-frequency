...
all: Fig2 Fig3_formula Fig4_formula Fig5_formula Fig6_formula Fig7_formula Fig3_simulation Fig4_simulation Fig5_simulation Fig6_simulation Fig7_simulation clean

Fig2: Fig2.c calc.o
	${CC} -o Fig2 Fig2.c calc.o ${end}
