...
{
	char filename[4][100] = {"Fig7_simulation_lambda=0.001_r=0.1_p=1.00_c2=001_b=0.dat", "Fig7_simulation_lambda=0.001_r=0.1_p=1.00_c2=001_b=0.75.dat", "Fig7_simulation_lambda=0.001_r=0.1_p=1.00_c2=001_b=0.9375.dat", "Fig7_simulation_lambda=0.001_r=0.1_p=1.00_c2=001_b=0.984375.dat"};
	...
	for (m=0; m<4; m++)
	{
		...
		for (i=min_exponent[m]; i<40; i++)
		{
			...
			calculate (f, c2_r_p_set, lambda[m], c1[m], n, N, COST_LINEAR, b[m], &avg, &stderror);
